"""nidl documentation build configuration file.
...
# We also add the directory just above to enable local imports of nidl
sys.path.insert(0, str(Path("..").absolute()))

from nidl.info import __version__
...
linkcheck_allowed_redirects = {
    ...
    r"https://github.com/neurospin-deepinsight/nidl/issues/.*": r"https://github.com/neurospin-deepinsight/nidl/pull/.*",
    # doi redirect
    "https://doi.org/": r"https://.*",
}

linkcheck_ignore = [
    # ignore nidl github issues mostly for the sake of speed
    # given that there many of those in our changelog
    r"https://github.com/neurospin-deepinsight/nidl/issues/.*",
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/neurospin-deepinsight/nidl/",
    "source_branch": "main",
...
html_short_title = "Nidl"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "logos/nidl-transparent.png"
...
extlinks = {
    ...
    "nidl-gh": ("https://github.com/neurospin-deepinsight/nidl/%s", None),
...
sphinx_gallery_conf = {
    ...
    # },
    "default_thumb_file": "logos/nidl-desaturate-100.png",
