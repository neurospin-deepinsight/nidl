...
from nidl.models.ssl.utils.heads import SimCLRProjectionHead
...
class SimCLR(BaseEstimator, EmbeddingTransformerMixin):
    ...
    Examples
    --------
    >>> from nidl.models.ssl import SimCLR
    >>> simclr = SimCLR(encoder="resnet18_3d", n_embedding=8)
    ...
    >>> simclr.fit(train_dataloader)
    >>> test_embedding = simclr.transform(test_dataloader)
    """
